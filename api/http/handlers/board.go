...
//Check The Handlers(GetPublicBoards , GetUserBoards) In Swagger UI And Their Returning And Entering Values Because The Swag commnad Does Not Handle The presentor.Paginated type.